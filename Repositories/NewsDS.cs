...
namespace WPAppStudio.Repositories
{
    ...
    public class NewsDS : INewsDS 
    {
        ...
        private const string RssUrl = "http://bsautermeister.blogspot.com/feeds/posts/default?alt=rss";

        /// <summary>
        /// Initializes a new instance of the <see cref="NewsDS" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public NewsDS(IXmlDataSource xmlDataSource)
        {
            _xmlDataSource = xmlDataSource;
        }

        /// <summary>
        /// Retrieves the data from a RSS data source (http://bsautermeister.blogspot.com/feeds/posts/default), in an observable collection of RssSearchResult items.
        /// </summary>
		...
		/// <summary>
        /// Retrieves the data from a RSS data source (http://bsautermeister.blogspot.com/feeds/posts/default), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
