...
namespace WPAppStudio.Repositories
{
    ...
    public class Windows8DS : IWindows8DS 
    {
        ...
        private const string RssUrl = "http://bsautermeister.blogspot.com/feeds/posts/default/-/Windows%208?alt=rss";

        /// <summary>
        /// Initializes a new instance of the <see cref="Windows8DS" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public Windows8DS(IXmlDataSource xmlDataSource)
        {
            _xmlDataSource = xmlDataSource;
        }

        /// <summary>
        /// Retrieves the data from a RSS data source (http://bsautermeister.blogspot.com/feeds/posts/default/-/Windows%208), in an observable collection of RssSearchResult items.
        /// </summary>
		...
		/// <summary>
        /// Retrieves the data from a RSS data source (http://bsautermeister.blogspot.com/feeds/posts/default/-/Windows%208), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
