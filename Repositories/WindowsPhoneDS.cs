...
namespace WPAppStudio.Repositories
{
    ...
    public class WindowsPhoneDS : IWindowsPhoneDS 
    {
        ...
        private const string RssUrl = "http://bsautermeister.blogspot.com/feeds/posts/default/-/Windows%20Phone?alt=rss";

        /// <summary>
        /// Initializes a new instance of the <see cref="WindowsPhoneDS" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public WindowsPhoneDS(IXmlDataSource xmlDataSource)
        {
            _xmlDataSource = xmlDataSource;
        }

        /// <summary>
        /// Retrieves the data from a RSS data source (http://bsautermeister.blogspot.com/feeds/posts/default/-/Windows%20Phone), in an observable collection of RssSearchResult items.
        /// </summary>
		...
		/// <summary>
        /// Retrieves the data from a RSS data source (http://bsautermeister.blogspot.com/feeds/posts/default/-/Windows%20Phone), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
